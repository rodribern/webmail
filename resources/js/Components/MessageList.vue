...
const emit = defineEmits(['toggle-seen', 'delete']);
...
<template>
    <div class="p-3 space-y-2" :style="{ '--primary-bg': primaryColor + '15', '--primary-bg-hover': primaryColor + '40' }">
        <!-- Empty state -->
        ...
        <Link
            ...
            class="group flex items-start p-3 rounded-xl transition-all duration-200 ease-out cursor-pointer message-card"
            :class="{
